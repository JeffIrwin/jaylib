...
void main()
{
	...
	int palette[NLAYERS] = int[](0xFBF8CC, 0xFDE4CF, 0xFFCFD2, 0xF1C0E8, 0xCFBAF0, 0xA3C4F3, 0x90DBF4, 0x8EECF5, 0x98F5E1, 0xB9FBC0);
	...
	//float z = 10 * y + 2 * sin(2*pi*x - 2*pi*vtime + sin(y + 2*pi*vtime/5));
	//float z = 10 * y + 3 * sin(x - 2*pi*vtime / 5);
	//float z = 7 * y + 3 * sin(x - 2*pi*vtime / 5 + sin(y + 2*pi*vtime / 2.5));
	float z = 5 * y + 3 * sin(x - 2*pi*vtime / 10 + 2 * sin(y + 2*pi*vtime / 5));
